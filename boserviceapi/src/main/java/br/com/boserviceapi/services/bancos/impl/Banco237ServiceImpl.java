...
@Service
public class Banco237ServiceImpl implements BancoService {

    private static final long serialVersionUID = 1L;

    private static final String NUMERO_BRAD = "237";
    private static final String DIGITO_NUMERO_BRAD = "2";
    ...
    public String getNumeroFormatadoComDigito() {
        return NUMERO_BRAD + "-" + DIGITO_NUMERO_BRAD;
    }
    ...
    private static Boleto from(BoletoBean boletoBean, Banco237ServiceImpl banco, Datas datas,
    ...
    public static Boleto boletoCreate(BoletoBean boletoBean) {
        ...
        Banco237ServiceImpl banco = new Banco237ServiceImpl();
