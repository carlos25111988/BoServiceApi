...
@Service
public class Banco707ServiceImpl implements BancoService {

    private static final long serialVersionUID = 1L;

    private static final String NUMERO_DAY = "707";
    private static final String DIGITO_NUMERO_DAY = "2";
    ...
    public String getNumeroFormatadoComDigito() {
        return NUMERO_DAY + "-" + DIGITO_NUMERO_DAY;
    }
    ...
    private static Boleto from(BoletoBean boletoBean, Banco707ServiceImpl banco, Datas datas,
    ...
    public static Boleto boletoCreate(BoletoBean boletoBean) {
        ...
        Banco707ServiceImpl banco = new Banco707ServiceImpl();
