...
@Service
public class Banco104ServiceImpl implements BancoService {
    ...
    public String getNumeroFormatadoComDigito() {
        return NUMERO_CAIXA + "-" + DIGITO_NUMERO_CAIXA;
    }
    ...
    private static Boleto from(BoletoBean boletoBean, Banco104ServiceImpl banco, Datas datas,
    ...
    public static Boleto boletoCreate(BoletoBean boletoBean) {
        ...
        Banco104ServiceImpl banco = new Banco104ServiceImpl();
